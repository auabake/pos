        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            ?>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="email" placeholder="Email ID" class="form-control" name="email" value="admin@gmail.com"/>
                 ...
                 <div class="form-group">
                    ...
                    <!-- <span class="text-warning">
                     ...
                     <input type="hidden" id="purchase_code" class="form-control" name="purchase_code" value='abcd1234' />
