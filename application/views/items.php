   ...
   <body class="hold-transition skin-blue  sidebar-mini">
    ...
    <!-- **********************MODALS END***************** -->
      ...
      <?php
         ...
         $sales_price=$purchase_price=$unit_id=$price=$alert_qty=$lot_number="";
         $stock = 0;
         $expire_date ='';
         $description ='';
         $final_price ='';
                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control only_currency" id="profit_margin" name="profit_margin" readonly placeholder=""  value="<?php print $profit_margin; ?>" >
                              ...
                              <div class="form-group col-md-4">
                                 ...
                                 <input type="text" class="form-control only_currency " id="sales_price" name="sales_price" readonly placeholder="Sales Price"  value="<?php print $sales_price; ?>" >
