                                       ...
                                       <div class="box-body">
                                          <div class="row">
                                             <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                <label for="profit_margin" class="col-sm-4 control-label"><?= $this->lang->line('profit_margin'); ?></label>
                                                   <div class="col-sm-4">
                                                      <input type="text" class="form-control" id="profit_margin" name="profit_margin" placeholder="" value="<?php print $profit_margin; ?>" >
