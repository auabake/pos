...
class Site_model extends CI_Model {
    public function get_details(){
		...
		if($query->num_rows()==0){
            ...
            $data['profit_margin']=$query->profit_margin;/* Default profit margin */
	...
	public function update_site(){
        ...
        sales_discount='$sales_discount',profit_margin='$profit_margin',change_return=$change_return,show_upi_code=$show_upi_code, 
        round_off=$round_off,
